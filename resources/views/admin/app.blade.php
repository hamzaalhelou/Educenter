														...
														<div class="row">
															...
															<div class="col-lg-6 mb-3">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="{{ route('admin.sliders.index') }}" class="menu-link active">
																		...
																		<span class="d-flex flex-column">
																			<span class="fs-6 fw-bold text-gray-800">Sliders
                                                                            </span>
															...
															<div class="col-lg-6 mb-3">
																...
																<div class="menu-item p-0 m-0">
																	...
																	<a href="{{ route('admin.features.index') }}" class="menu-link">
																		...
																		<span class="d-flex flex-column">
																			<span class="fs-6 fw-bold text-gray-800">Features
                                                                            </span>
																		</span>
																	</a>
																	<!--end:Menu link-->
															...
															<div class="col-lg-6 mb-3">
																...
																<div class="menu-item p-0 m-0">
																	...
																	<a href="{{ route('admin.courses.index') }}" class="menu-link">
																		...
																		<span class="d-flex flex-column">
																			<span class="fs-6 fw-bold text-gray-800">Courses</span>
																		</span>
																	</a>
																	<!--end:Menu link-->
																</div>
															...
															<div class="col-lg-6 mb-3">
																...
																<div class="menu-item p-0 m-0">
																	...
																	<a href="{{ route('admin.research.index') }}" class="menu-link">
																		...
																		<span class="d-flex flex-column">
																			<span class="fs-6 fw-bold text-gray-800">Research</span>
																		</span>
																	</a>
																	<!--end:Menu link-->
																</div>
															...
															<div class="col-lg-6 mb-3">
																...
																<div class="menu-item p-0 m-0">
																	...
																	<a href="{{ route('admin.roles.index') }}" class="menu-link">
																		...
																		<span class="d-flex flex-column">
																			<span class="fs-6 fw-bold text-gray-800">Roles
                                                                            </span>
																		</span>
																	</a>
																	<!--end:Menu link-->
															...
															<div class="col-lg-6 mb-3">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="{{ route('admin.journalists.index') }}" class="menu-link">
																		<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
																		...
																		<span class="d-flex flex-column">
																			<span class="fs-6 fw-bold text-gray-800">Journalists</span>
																		</span>
																	</a>
																	<!--end:Menu link-->
																</div>
															...
															<div class="col-lg-6 mb-3">
																...
																<div class="menu-item p-0 m-0">
																	...
																	<a href="{{ route('admin.events.index') }}" class="menu-link">
																		...
																		<span class="d-flex flex-column">
																			<span class="fs-6 fw-bold text-gray-800">Events</span>
																		</span>
																	</a>
																	<!--end:Menu link-->
																</div>
