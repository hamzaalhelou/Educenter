...
<div class="d-flex justify-content-between align-items-center  mb-4">
    <h1 class="h3 text-gray-800 mb-0 ms-9">{{ __('admin.Add New Research') }}</h1>
    <a class="btn btn-primary me-17 " href="{{ route('admin.research.index') }}">{{ __('admin.All Researchs') }}</a>
</div>

<form action="{{ route('admin.research.store') }}" method="POST" enctype="multipart/form-data" class="container">
@csrf
<hr>
